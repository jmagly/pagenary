...
id: PGR-0002
status: open
title: "Hosted build worker: shell-injection risk in git command execution"
type: task
priority: P2
labels: []
assignees: []
created_at: 2026-06-27T18:25:13.769Z
updated_at: 2026-06-27T18:25:13.769Z
closed_at: null
links:
  external:
    - https://git.integrolabs.net/roctinam/pagenary/issues/80
  parent: null
  children: []
  related: []
source:
  provider: gitea
  external_id: "80"
  external_url: https://git.integrolabs.net/roctinam/pagenary/issues/80
---
# Severity
P1 (critical)
