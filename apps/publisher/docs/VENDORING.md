...
|---|---|---|---|
| `src/vendor/fortemi-aiwg-index.js` (+ `.d.ts`) | `@fortemi/core` `./aiwg-index` | `2026.6.7` | Static search/index engine. See [ADR-015](../../../.aiwg/architecture/adr/ADR-015-fortemi-core-search-adapter.md). |
...
**exact** vendored version (e.g. `"@fortemi/core": "2026.6.7"`). The build never
