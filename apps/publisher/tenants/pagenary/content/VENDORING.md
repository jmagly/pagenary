...
|---|---|---|---|
| `src/vendor/fortemi-aiwg-index.js` (+ `.d.ts`) | `@fortemi/core` `./aiwg-index` | `2026.6.8` | Static search/index engine, including relationship metadata plus optional SKOS/provenance record fields. See [ADR-015](https://git.integrolabs.net/roctinam/pagenary/src/branch/main/.aiwg/architecture/adr/ADR-015-fortemi-core-search-adapter.md). |
...
**exact** vendored version (e.g. `"@fortemi/core": "2026.6.8"`). The build never
...
- [`ADR-015`](https://git.integrolabs.net/roctinam/pagenary/src/branch/main/.aiwg/architecture/adr/ADR-015-fortemi-core-search-adapter.md) —
